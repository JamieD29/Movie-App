...
import { userSignup } from './authThunk';
...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      <button className='mr-2 border-none bg-transparent cursor-pointer hover:text-rose-600 active:text-rose-300 ' onClick={() => navigate(-1)}><LeftCircleOutlined className='text-3xl mt-4'/></button>
